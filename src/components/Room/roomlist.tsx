      ...
      <div>
        <div className="w-full">
          <div className="sm:flex items-center justify-between py-2">
            <Link to={`/add-room`}>
              <button
                  className=" focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex items-center px-2 space-x-1 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded">
                <img className="w-6 h-6" src="https://img.icons8.com/color/plus.png" alt="" />
          ...
          <div className="bg-white shadow-md rounded ">
            <table className="min-w-max w-full table-auto">
              ...
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                <th className="py-3 px-6 text-left">Buildings</th>
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-100" key={room.id} >
                    <td className="py-3 px-6 text-left whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="mr-2">
                          <img className="w-6 h-6" src="https://img.icons8.com/color/room.png" alt="" />
                        </div>
