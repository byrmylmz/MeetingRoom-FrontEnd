...
const Sidebar: FC<SidebarProps> = (props) => {
    return (
        <div className="overflow-y-auto overflow-x-hidden w-[256px] min-w-[256px] max-w-[256px] border-r">
            <Link to={`/rooms`}>
            ...
            <span className="inline-flex justify-center items-center ml-4">
              ...
              >
                ...
                ></path>
                        ...
                        <span className="ml-2 text-sm tracking-wide truncate">Captive Portal</span>
                        <span
            ...
            <span className="inline-flex justify-center items-center ml-4">
              ...
              >
                ...
                ></path>
                        ...
                        <span className="ml-2 text-sm tracking-wide truncate">Log Management</span>
                        <span
              ...
              15
                ...
                {/*      </svg>*/}
                {/*    </span>*/}
                {/*    <span className="ml-2 text-sm tracking-wide truncate">Administration</span>*/}
                {/*  </a>*/}
                {/*</li>*/}
                <li>
                    <a
