...
function Room() {
  ...
  return (
    <>
      <Tabs defaultActiveKey="Main" id="RoomAdd" className="mb-3">
        <Tab eventKey="Main" className="min-h-[400px]" title="Main">
          ...
          <Form.Group className="mb-3" controlId="formBasicCheckbox">
            <Form.Check
              type="checkbox"
              label="Check me out"
              {...register("onCheck", { required: true })}
            />
            {errors["onCheck"] && (
              <small className="text-red-600">You must accept this form.</small>
            )}
          </Form.Group>
        </Tab>
        ...
        >
          <Form.Group className="mb-3" controlId="formBasicCheckbox">
            ...
            <Form.Check
              type="checkbox"
              label="DIBS Room(Room can be use directly through screen)"
              {...register("dibsRoom")}
            />
          </Form.Group>
          <Form.Group className="mb-3" controlId="formBasicCheckbox">
